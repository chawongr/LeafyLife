    ...
    return (
        <div className="w-fit">
            <FadeIn delay={0.1} direction="up">
                {showSignInModal ? (
                    // Render the SigninModal within the same modal
                            ...
                            <div className="flex justify-center">
                                <div className="flex flex-col w-11/12">
                                    ...
                                    <div className="pt-8 pb-4">
                                        <button onClick={handleSignUp} className="w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg text-[18px] font-medium">
